...
public class NewAccount2 extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae){
        ...
        String a = (String)c1.getSelectedItem(); //religion
        String b = (String)c2.getSelectedItem();//category
        String c = (String)c3.getSelectedItem();//income
        String d = (String)c4.getSelectedItem();//education
        String e = (String)c5.getSelectedItem();//occupation
        
        String f = t1.getText();//pan
        String g = t2.getText();//aadhaar
        ...
        try{
            ...
            if(t2.getText().equals("")){
                ...
                conn c1 = new conn();
                String q1 = "update user set religion=' "+a+" ',category=' "+b+" ',income=' "+c+" ',education_qualification=' "+d+" ',occupation=' "+e+" ',pan_no=' "+f+" ',aadhaar_no=' "+g+" '  where pan_no='n' "        ;
